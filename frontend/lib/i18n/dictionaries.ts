...
export const en = {
  ...
  "journal.export.title": "Download the full ledger as a spreadsheet",
  "journal.export.doneTitle": "Journal exported",
  "journal.export.doneBody": "{count} rows written to ORACLE_Trading_Journal.csv",
  "journal.export.emptyTitle": "Nothing to export",
  "journal.export.emptyBody": "The ledger is still empty.",
  "journal.feesNote": "PnL is net of 0.1% simulated fee per side",
  "journal.smartStop.title": "Smart Protection",
  "journal.smartStop.liveTitle": "Smart Protection · Live",
  "journal.smartStop.liveFailedTitle": "Could not move exchange Stop Loss",
  "journal.smartStop.bep": "Stop Loss moved to Break-Even (Entry) at {price} to secure your capital.",
  "journal.smartStop.trail": "Stop Loss locked into +5% profit at {price} — this trade can no longer lose.",
  "journal.smartStop.continuous": "Stop Loss trailed up to {price}, riding behind the profit high-water mark.",
  "journal.watchdogExit.title": "Position closed by watchdog",
  "journal.watchdogExit.sl": "{symbol} had no exchange-side stop, so ORACLE closed it at your Stop Loss (~{price}) the moment price reached it.",
  "journal.watchdogExit.tp": "{symbol} had no exchange-side stop, so ORACLE closed it at your Take Profit (~{price}) the moment price reached it.",
  "journal.watchdogExit.failedTitle": "Could not close unprotected position",
  "journal.unprotected.badge": "NO EXCHANGE STOP",
  ...
  "journal.liveBalance": "Live Balance",
  "journal.liveBalanceSub": "{exchange} · real stablecoin balance",
  "journal.virtualBalanceSub": "simulation · $10,000 start",
  "journal.balanceUnavailable": "Exchange balance unavailable — showing simulation",
  "journal.badge.paper": "PAPER",
  "journal.badge.live": "REAL",
  "journal.badge.paperTitle": "Simulation — not a real order",
  "journal.badge.liveTitle": "Real order on your exchange account",
  "journal.ledgerLegend": "PAPER = simulation (local) · REAL = live exchange account",
  "journal.manual.tag": "MANUAL",
...
export const id: Record<TranslationKey, string> = {
  ...
  "journal.export": "Ekspor CSV",
  "journal.export.title": "Unduh seluruh ledger sebagai spreadsheet",
  "journal.export.doneTitle": "Jurnal diekspor",
  "journal.export.doneBody": "{count} baris ditulis ke ORACLE_Trading_Journal.csv",
  "journal.export.emptyTitle": "Tidak ada yang bisa diekspor",
  "journal.export.emptyBody": "Ledger masih kosong.",
  "journal.feesNote": "PnL sudah dipotong fee simulasi 0,1% per sisi",
  "journal.smartStop.title": "Proteksi Pintar",
  "journal.smartStop.liveTitle": "Proteksi Pintar · Live",
  "journal.smartStop.liveFailedTitle": "Gagal menggeser Stop Loss bursa",
  "journal.smartStop.bep": "Stop Loss otomatis digeser ke Break-Even (Entry) di {price} untuk mengamankan modal Anda.",
  "journal.smartStop.trail": "Stop Loss dikunci di area profit +5% pada {price} — trade ini tidak bisa lagi rugi.",
  "journal.smartStop.continuous": "Stop Loss mengekor naik ke {price}, membuntuti titik profit tertinggi.",
  "journal.watchdogExit.title": "Posisi ditutup oleh watchdog",
  "journal.watchdogExit.sl": "{symbol} tidak punya stop di sisi bursa, jadi ORACLE menutupnya di Stop Loss Anda (~{price}) begitu harga menyentuhnya.",
  "journal.watchdogExit.tp": "{symbol} tidak punya stop di sisi bursa, jadi ORACLE menutupnya di Take Profit Anda (~{price}) begitu harga menyentuhnya.",
  "journal.watchdogExit.failedTitle": "Gagal menutup posisi tak terlindungi",
  "journal.unprotected.badge": "TANPA STOP BURSA",
  "journal.table.notes": "Catatan",
  ...
  "journal.liveBalance": "Saldo Live",
  "journal.liveBalanceSub": "{exchange} · saldo stablecoin asli",
  "journal.virtualBalanceSub": "simulasi · mulai $10.000",
  "journal.balanceUnavailable": "Saldo bursa tidak tersedia — menampilkan simulasi",
  "journal.badge.paper": "PAPER",
  "journal.badge.live": "REAL",
  "journal.badge.paperTitle": "Simulasi — bukan order sungguhan",
  "journal.badge.liveTitle": "Order sungguhan di akun bursa Anda",
  "journal.ledgerLegend": "PAPER = simulasi (lokal) · REAL = akun bursa live",
  "journal.manual.tag": "MANUAL",
